...
import { ReadmeAndEnvDialog } from "../../../../shared/MyServicesCard/ReadmeAndEnvDialog";
...
export const MyProcessesCard = memo((props: Props) => {
    const {
        className,
        evtAction,
        chartIconUrl,
    ...
    const { t } = useTranslation({ MyProcessesCard });
    ...
    return (
        <div className={cx(classes.root, className)}>
            <div className={classes.aboveDivider}>
                ...
                <div style={{ "flex": 1 }} />
                {isShared && (
                    <Tooltip title={t("this is a shared process")}>
                ...
                <Tooltip
                    title={
                        <Fragment key={"reminder"}>
                            {t("reminder to delete processes")}
                        </Fragment>
                    }
                >
                    <Icon
